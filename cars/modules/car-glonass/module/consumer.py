...
def send_periodic_updates():
    while True:
        ...
        send_to_complex(str(uuid.uuid4()), details)
        send_to_geodata(str(uuid.uuid4()), details1)
        time.sleep(15)
    
def send_to_complex(id, details):
    details["deliver_to"] = "car-complex"
    details["id"] = id
    proceed_to_deliver(id, details)
        
def send_to_geodata(id, details):
    details["deliver_to"] = "car-get-speed-from-geo"
    details["id"] = id
    proceed_to_deliver(id, details)
