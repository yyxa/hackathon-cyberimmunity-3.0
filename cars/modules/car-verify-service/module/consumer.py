...
def validate_command(details):
    # валидация команды
    return

def send_to_car_control(details):
    validate_command(details)
...
def handle_event(id, details_str):
    ...
    if operation == "car_start":
        details["operation"] = "car_start"
        return send_to_car_control(details)
    elif operation == "car_stop":
        details["operation"] = "car_stop"
        return send_to_car_control(details)
    elif operation == "invoice_id":
        details["operation"] = "invoice_id"
        return send_to_car_control(details)
    elif operation == "occupy":
        details["operation"] = "occupy"
        return send_to_car_control(details)
