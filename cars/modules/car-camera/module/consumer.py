...
def send_periodic_updates():
    while True:
        ...
        send_to_speed(str(uuid.uuid4()), details)
        send_to_driver(str(uuid.uuid4()), details1)
        time.sleep(15)
    
def send_to_speed(id, details):
    details["deliver_to"] = "car-get-speed-from-camera"
    details["id"] = id
    proceed_to_deliver(id, details)
        
def send_to_driver(id, details):
    details["deliver_to"] = "car-verify-driver"
    details["id"] = id
    proceed_to_deliver(id, details)
